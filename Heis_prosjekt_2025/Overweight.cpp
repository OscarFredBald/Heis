...
//Konstruktør
// Denne funksjonen kjøres automatisk når du oppretter et nytt Overweight-objekt.
// Den lagrer hvilken analog pin du bruker, hvilken terskelverdi (threshold) som gjelder,
